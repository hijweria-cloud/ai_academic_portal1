...
<head>
    <meta charset="UTF-8">
    <title>Student Dashboard | AI Academic Portal</title>
...
<div class="container dashboard">
    <div class="card">
        <h2 class="card-title">Welcome, <?= htmlspecialchars($_SESSION['student_name']) ?>!</h2>
        <p><strong>Program:</strong> <?= htmlspecialchars($_SESSION['program']) ?></p>
        <p><strong>Semester:</strong> <?= htmlspecialchars($_SESSION['semester']) ?></p>
        <a href="programs.php" class="btn btn-custom mt-3">View Programs</a>
    </div>
</div>
